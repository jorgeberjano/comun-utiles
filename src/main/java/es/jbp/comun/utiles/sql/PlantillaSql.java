...
public class PlantillaSql {
    ...
    public PlantillaSql(String sql, FormateadorSql formateadorSql) {
        this.sql = sql;
        this.formateadorSql = formateadorSql;
    }

    public PlantillaSql(URL url, FormateadorSql formateadorSql) throws IOException {
        this(url.openStream(), formateadorSql);
    }
    
    public PlantillaSql(InputStream inputStream, FormateadorSql formateadorSql) throws IOException {
    ...
    private String getValorSimbolo(String simbolo) {
        ...
        if (valor == null) {
            valor = Conversion.toString(obtenerParametro(simbolo));
        }
    ...
    public String getResultado() {
        ...
        StringBuilder builder = new StringBuilder(sustituirSimbolosSql(sql));
